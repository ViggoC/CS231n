...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        # 经过一个maxpool，input size变小；要记得conv的输入是没有通道维度的
    ...
    def loss(self, X, y=None):
        ...
        l2_relu_out, l2_relu_cache= relu_forward(l2_out)
        l3_out, l3_cache = affine_forward(l2_relu_out, W3, b3)
        scores = l3_out.copy()
        ...
        drelu2 = relu_backward(dx3, l2_relu_cache)
        dx2, dw2, db2 = affine_backward(drelu2, l2_cache)
        dx1, dw1, db1 = conv_relu_pool_backward(dx2, l1_cache)
